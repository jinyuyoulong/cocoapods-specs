Pod::Spec.new do |s|
   ...
   s.platform     = :ios, '9.0'
   s.source       = { :git => 'https://gitcode.net/ioschina/aws-sdk-ios.git',
                      :tag => s.version}
   s.requires_arc = true

   s.dependency 'AWSAuthCore', '2.27.0'
   s.dependency 'AWSCognitoIdentityProvider', '2.27.0'
   ...
   s.dependency 'AWSCognitoIdentityProviderASF', '2.27.0'
